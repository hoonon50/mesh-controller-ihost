...
- v5.0.4 do jeho datové části položí vlastní řízenou live vrstvu.
...
- Dockerfile v5.0.4 už nespouští v501_refresh_tune.py ani v502_live_refresh_patch.py.


UI FIX v5.0.4
- Odstraněny vizuálně duplicitní staré řádky CPU a UPTIME v každé topology kartě.
- Zůstává pouze živý CPU a UPTIME z explicitního live API.
- Živé hodnoty jsou posunuty výš na místo původních řádků.
- Dlaždice jsou nižší a kompaktnější.
- Live polling, klienti, mesh spoje, dBm a rychlosti jsou beze změny.
