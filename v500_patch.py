...
css_tag = '<link rel="stylesheet" href="/static/v500_operation.css?v=5.0.1">'
js_tag = '<script src="/static/v500_operation.js?v=5.0.1"></script>'
...
print("v5.0.1: persistentní REBOOT + OWUT manager + rychlejší live refresh")
